package org.dobots.balltrackermodule.aim;
...
public class BallTrackerModuleService extends Service {
	private static final String TAG = "BallTrackerModuleService";
...
//	}
	...
	private class AIMRun extends AsyncTask<Integer, Void, Boolean> {
		protected Boolean doInBackground(Integer... id) {
			...
			int input = 3;
			BallTrackerModule aim = new BallTrackerModule();
...
//		}
	...
	// static constructor
	static {
		System.loadLibrary("BallTrackerModule");
	}
