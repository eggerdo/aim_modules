package org.dobots.balltrackermodule;
...
import org.dobots.balltrackermodule.aim.*;

public class MainActivity extends Activity {
private static final String TAG = "MainActivity";
private static final String MODULE_NAME = "BallTrackerModule";
...
protected void onCreate(Bundle savedInstanceState) {
	...
	private void startService() {
		...
		intent.setClassName("org.dobots.balltrackermodule", "org.dobots.balltrackermodule.aim.BallTrackerModuleService");
...
//		finish();
    ...
    private boolean checkServiceRunning() {
		...
		for (RunningServiceInfo service : manager.getRunningServices(Integer.MAX_VALUE)) {
			if (BallTrackerModuleService.class.getName().equals(service.service.getClassName())) {
